...
//  MetaMerge
//
//  Created by Dan Hushon on 11/20/17.
...
class XMLDictionaryParser: NSObject, XMLParserDelegate {
    ...
    func parser(_ parser: XMLParser, didStartElement elementName: String, namespaceURI: String?, qualifiedName qName: String?, attributes attributeDict: [String : String])
    {
        ...
        stack.push(aNode)
        currentNode = aNode
        //TODO: no protection for badly formed XML or "duplicate" tags at same level = array
        //TODO: no support for namepaceURI, qualifiedName nor attributes
    }
